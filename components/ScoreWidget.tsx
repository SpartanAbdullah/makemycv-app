...
export default function ScoreWidget() {
  ...
  // Layout-agnostic — the parent decides positioning. Inside the flex stack
  // at the bottom-right of the builder viewport, we just render the glow +
  // the pill. The floating behaviour lives in BuilderShell's container.
  return (
