...
export default function ShareButton() {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-10 min-w-[8.75rem] items-center justify-center gap-2 rounded-full border border-line bg-paper px-3 py-1.5 text-sm font-medium text-slate-700 transition hover:bg-paper-2"
    >
      {copied ? (
        <>
